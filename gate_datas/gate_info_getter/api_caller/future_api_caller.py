...
from gate_datas.gate_info_getter.entity import FuturePriceInfo, RateInfo
...
def future_funding_rate(pair,limit=1000):
    api_instance = gate_api.FuturesApi(api_client)
    try:
        # Funding rate history
        api_response = api_instance.list_futures_funding_rate_history('usdt', pair, limit=limit)
        return api_response
